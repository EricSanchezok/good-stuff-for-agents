...
<p align="center">
  ...
  <a href="docs/skills/README.md"><img alt="Indexed skills" src="https://img.shields.io/badge/skills-2-B879FF?style=for-the-badge&labelColor=101014"></a>
...
| --- | --- | --- |
| [CodeRabbit Review Remediation Workflow](docs/packs/code-review/pack_coderabbit-review-remediation_f00daeba.md) | Governed review-to-remediation of CodeRabbit findings: severity-grouped review findings feed an independently-verified, human-gated fix workflow. | 78% minimum review score · Ready to use |

## Browse by domain

- [Code Review](docs/domains/code-review.md) · 1 packs · 0 skills
