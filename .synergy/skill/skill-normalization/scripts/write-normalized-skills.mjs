...
function assertNormalizedDraft(skill) {
  ...
  if (!skill.identity?.current_version_id && !skill.version_id) throw new Error(`Skill draft ${skill.display_name ?? skill.canonical_name ?? skill.canonical_skill_id} is missing version identity`)
}
