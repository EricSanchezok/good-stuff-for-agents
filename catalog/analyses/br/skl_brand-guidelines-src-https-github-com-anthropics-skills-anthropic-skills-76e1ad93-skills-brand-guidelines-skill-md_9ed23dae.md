...
analysis_version: 1
confidence: unknown
updated_at: "2026-07-08T09:51:36.540Z"
---
...
## Trigger Semantics
Load when an agent needs expertise in brand-guidelines. Reserve for tasks matching the skill scope.

## Capability Breakdown
Primary domain: frontend-design. From src_https-github-com-anthropics-skills-anthropic-skills_76e1ad93 (Apache-2.0). Content-based brand-guidelines workflow guidance.

## Workflow Role
Use during frontend-design workflow stages. Fits within broader agent orchestration at appropriate handoff points.

## Inputs / Outputs
Inputs: task context. Outputs: brand-guidelines results. Handoff: structured output.
