...
#   - catalog/runs/
#   - reports/nightly-catalog-ops/ reports/catalog-growth-ops/ reports/source-discovery/ reports/nightly/
#   - docs/                   所有生成的公共页面
#   - README.md              重置为干净模板
...
echo "══════════════════════════════════════════════"
echo "  🔍 预览：将删除以下 catalog/reports 运行产物"
echo "══════════════════════════════════════════════"
echo ""
